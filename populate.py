...
tables = {
    ...
    "tipo_projeto" : [
        ["DEFAULT", "Ciências Sociais Aplicadas"],
        ["DEFAULT", "Linguística, Letras e Artes"],
        ["DEFAULT", "Engenharias"],
        ["DEFAULT", "Outra"],
        ["DEFAULT", "Ciências Humanas"],
        ["DEFAULT", "Ciências Exatas e da Terra"],
        ["DEFAULT", "Ciências da Saúde"],
        ["DEFAULT", "Ciências Biológicas"]
    ],
    "projeto" : [
        ["DEFAULT", 3, '"Laboratório de Pesquisa em História e Historiografia do Brasil"', '2021-08-09', '2024-09-08', ],
        ["DEFAULT", 4, '(Im)polidez em diferentes contextos sócio/interculturais', '2018-11-12', '2022-07-21'],
        ["DEFAULT", 7, 'A1 Rota da Seda na Antigüidade', '2010-12-27', '2020-09-25'],
        ["DEFAULT", 6, 'A Sustentabilidade em Arquitetura e Urbanismo', '2023-10-16', '2010-03-31'],
        ["DEFAULT", 7, 'A formação do professor de língua estrangeira', '2010-05-11', '2012-10-23'],
        ["DEFAULT", 5,'A fraseologia e sua equação nas sub-áreas da Lingüística Aplicada', '2011-06-30', '2019-12-29'],
        ["DEFAULT", 4, 'A tradução como ferramenta de resistência e inclusão', '2014-09-06', '2016-01-07'],
        ["DEFAULT", 6, 'AFETO - Grupo de Pesquisa em Etnocenologia', '2011-05-13', '2021-07-07'],
        ["DEFAULT", 8, 'ALEA- Laboratório de Associação da Linguística, Educação e Antropologia em Estudos do Contato de Línguas, Dialetos e Grupos Sociais na Europa, África e Américas', '2018-04-07', '2011-04-03'],
        ["DEFAULT", 7, 'AMAMENTAÇAO E SAUDE', '2022-02-20', '2012-03-21'],
        ["DEFAULT", 6, 'AQUARELA - Aplicações com Qualidade de Serviços em Redes de Alta Velocidade', '2017-07-25', '2023-03-16'],
        ["DEFAULT", 5, 'AQUARIPARIA', '2015-10-28', '2018-09-03'],
        ["DEFAULT", 2, 'AQUASENSE - Sensoriamento remoto para o monitoramento da qualidade das águas continentais', '2022-03-24', '2011-04-13'],
        ["DEFAULT", 3, 'ARCHAI: AS ORIGENS DO PENSAMENTO OCIDENTAL', '2014-11-29', '2023-11-30'],
        ["DEFAULT", 3, 'AVALIAÇÃO DE RISCO DA EXPOSIÇÃO HUMANA A RESIDUOS E CONTAMINANTES', '2011-11-28', '2020-12-13'],
        ["DEFAULT", 7, 'Acesso Livre', '2013-06-30', '2024-10-20'],
        ["DEFAULT", 2, 'Acesso a Medicamentos e Uso Responsável - AMUR', '2024-10-27', '2011-10-19'],
        ["DEFAULT", 6, 'AcquaUnB', '2021-12-25', '2016-11-18'],
        ["DEFAULT", 3, 'Adaptações estruturais e funcionais de plantas em resposta a variações ambientais', '2023-06-24', '2022-01-07'],
        ["DEFAULT", 2, 'Administração Pública Comparada', '2014-05-15', '2014-08-31'],
        ["DEFAULT", 3, 'Administração da Justiça', '2021-04-12', '2011-09-25'],
        ["DEFAULT", 8, 'Alimentação e Microbiota intestinal', '2018-01-06', '2018-04-25'],
        ["DEFAULT", 8, 'Alimentação e qualidade de vida nas restrições alimentares', '2020-06-09', '2018-12-26'],
        ["DEFAULT", 7,  'Ambiente 33 - Espacialidades, Comunicação, Estética e Tecnologias', '2011-06-23', '2012-09-08'],
        ["DEFAULT", 8,'Anarchai - Metafísica e política contemporâneas', '2015-11-20', '2017-05-27'],
        ["DEFAULT", 6,'Animalia: Grupo de Estudos sobre as Relações entre Humanos e Animais na Antiguidade', '2015-04-19', '2022-02-05'],
        ["DEFAULT", 4, 'Antropologia Política da Saúde', '2021-07-13', '2016-09-25'],
        ["DEFAULT", 7, 'Análise e Produção de Materiais Didáticos Multimodais para o Ensino de Línguas', '2015-05-08', '2015-12-11'],
        ["DEFAULT", 2, 'Análises Laboratoriais Aplicadas', '2024-04-29', '2020-03-29'],
        ["DEFAULT", 6, 'Aprendizagem Colaborativa on-line -GPACO', '2017-11-16', '2013-05-04'],
        ["DEFAULT", 8,'Aprendizagem Lúdica: Pesquisas e Intervenções em Educação e Desporto', '2014-08-10', '2020-02-14'],
        ["DEFAULT", 2,'Aprendizagem, Comportamento e Letramento informacional', '2013-06-18', '2010-07-18'],
        ["DEFAULT", 7,'Aprendizagem, escolarização e desenvolvimento humano', '2010-05-12', '2010-09-16'],
        ["DEFAULT", 6, 'Aprendizagens,Tecnologias e Educação a Distância', '2020-08-20', '2010-01-11'],
        ["DEFAULT", 2, 'Arquitetura e Urbanismo da Região de Brasília', '2014-05-04', '2023-08-13'],
        ["DEFAULT", 8, 'Arte Computacional', '2014-02-07', '2022-01-13'],
        ["DEFAULT", 3, 'Arte, Sociedade e Interpretações do Brasil', '2010-06-11', '2012-10-12'],
        ["DEFAULT", 6, 'As Tecnologias da Informação e Comunicação nos Processos de Formação Musical', '2019-10-08', '2017-09-27'],
        ["DEFAULT", 5, 'Aspectos microbiológicos e imunológicos da interação hospedeiro-fungo', '2021-01-02', '2015-09-20'],
        ["DEFAULT", 5, 'Avaliação computacional de dados, processos e moléculas de interesse na saúde humana', '2020-07-05', '2024-07-28'],
        ["DEFAULT", 8, 'Avaliação de tecnologias em doenças tropicais negligenciadas', '2018-05-10', '2014-10-13'],
        ["DEFAULT", 7,  'Avaliação e Intervenção em Fisioterapia (GPAFi)', '2014-01-21', '2018-03-18'],
        ["DEFAULT", 4, 'Avaliação e organização do trabalho pedagógico', '2025-09-23', '2024-08-12'],
        ["DEFAULT", 1, 'BICAS - Iniciativa BRICS de Estudos sobre Transformações Agrárias', '2020-07-18', '2015-06-28'],
        ["DEFAULT", 5, 'BRANDING: CONSTRUÇÃO, POSICIONAMENTO, IMAGEM E IDENTIDADE DE MARCA', '2015-04-05', '2014-10-01'],
        ["DEFAULT", 6, 'Bactérias aeróbias formadoras de endósporos - Bafes', '2020-09-21', '2015-03-22'],
        ["DEFAULT", 2, 'Bactérias lácticas e Probióticos na Alimentação', '2011-07-31', '2023-08-05'],
        ["DEFAULT", 7, 'Bases moleculares da interação hospedeiro-patógeno (fungos patogênicos: P. brasiliensis, C. albicans e C. neoformans)', '2025-09-20', '2016-01-10'],
        ["DEFAULT", 4, 'BiTGroup - Grupo de Pesquisa em Sistemas Biométricos', '2023-07-31', '2016-10-13'],
        ["DEFAULT", 8, "AQUARIPARIA", "2014-02-20", "2024-01-09"],
    ],
    "congresso" : [
        ["DEFAULT", "CSBC", "..."],
        ["DEFAULT", "Congresso Brasileiro de Cardiologia", ".."],
        ["DEFAULT", "Congresso Brasileiro de Informática na Educaç", "..."],
        ["DEFAULT", "Simpósio Brasileiro de Banco de Dados", "..."],
        ["DEFAULT", "Simpósio Brasileiro de Educação em Computação", "..."]
    ],
    "edicao" : [
        [1, 2025],
        [2, 80],
    ...
    "linha_pesquisa" : [
        ...
        ["DEFAULT", "Comunidades Aquáticas"],
        ["DEFAULT", "Comunidades Terrestres"],
        ["DEFAULT", "Decomposição de Detritos"],
        ["DEFAULT", "Dinâmica de Matéria Orgânica"],
        ["DEFAULT", "Ecologia da Paisagem e Clima"],
        ["DEFAULT", "Ecologia Isotópica"],
        ["DEFAULT", "Extensão"],
        ["DEFAULT", "Funcionamento de Ecossistemas"],
        ["DEFAULT", "Manejo integrado de bacias hidrográficas"],
        ["DEFAULT", "Modelagem Ecológica"],
        ["DEFAULT", "Monitoramento de Sistemas Aquáticos"],
        ["DEFAULT", "Peixes indicadores de qualidade ambiental"],
        ["DEFAULT", "Restauração Ecológica"],
        ["DEFAULT", "Transferência de Tecnologia e Popularização da Ciência"]
    ],
    "membro" : [
    ...
    "fomenta" : [
        [38174000143, 1, "Univ"], # Projeto 0 fomentado pela UnB
        [63025530000104,2, "Univ"], # Projeto 1 fomentado pela USP
        [17217985000104,3, "Univ"], # Projeto 2 fomentado pela UFMG
        [1567601000143,4, "Univ"], # Projeto 3 fomentado pela UFG
        [66991647000130,5, "Univ"] # Projeto 4 fomentado pela UFSCAR 
    ],
    "participa" : [
    ...
    "pesquisa" : [
        [1, 1, "Coordenador"], # Pesquisador 1 pesquisa Projeto 0
        [1, 2, "Pesquisador"], # Pesquisador 1 pesquisa Projeto 1
        [1, 3, "Coordenador"], # Pesquisador 1 pesquisa Projeto 2
        [2, 4, "Coordenador"], # Pesquisador 2 pesquisa Projeto 3
        [2, 5, "Coordenador"] # Pesquisador 2 pesquisa Projeto 4
    ],
    "realiza" : [
    ...
    "email" : [
        ["pudim@gov.br", 1],
        ["magicodeoz@mail.oz", 2],
        ["alice@maravilhas.pais", 3],
        ["kafka@morfose.meta", 3],
        ["joao@joao.joao", 5]
    ],
    "origem" : [
        [70910900, 2],
        ...
        for k, v in tables.items():
            for linha in v:
                ...
                for i in range(len(linha)):
                    if type(linha[i]).__name__ == "str" and linha[i] != "DEFAULT" and linha[i] != "NULL":
                        valores += f"'{linha[i]}'"
                    else:
                        valores += f"{linha[i]}"
